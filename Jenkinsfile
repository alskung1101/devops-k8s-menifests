        ...
        stage('update Vue rollout.yaml') {
            ...
            steps {
                dir('university-vue') {
                    ...
                    sh "sed -i 's|alskung/university-vue:.*|alskung/university-vue:${params.DOCKER_IMAGE_VERSION}|g' rollout.yaml"
                    sh 'cat rollout.yaml'
                }
            }
        }
        ...
        stage('update API rollout.yaml') {
            ...
            steps {
                dir('department-api') {
                    ...
                    sh 'ls -al'
                    echo "Received Docker Image Version : ${params.DOCKER_IMAGE_VERSION}"
                    sh "sed -i 's|alskung/department-service:.*|alskung/department-service:${params.DOCKER_IMAGE_VERSION}|g' rollout.yaml"
                    sh 'cat rollout.yaml'
                }
            }
        }
